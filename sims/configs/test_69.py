...
# This is 63 wuth 48 instead of 24 steps and TWO updates instead of one
class Test(DefaultTest):
    # simulation and training params
    test_ID = "test_69"
    num_days = 40
    ep_len = 48  # num_days * 24 * 4  # 'x' days of 15 minute timesteps
    num_episodes = 100
    ...
    skip_first = 0
    update_strategy = UpdateStrategy(24, skip_first=skip_first, hook="on_timestep_end")
    learning_rate = 1e-1
