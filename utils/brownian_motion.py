...
def brownian_bridge(steps: int, noise_width: float, np_random: np.random.Generator) -> np.ndarray:
    """
...
def brownian_excursion(steps: int, noise_width: float, np_random: np.random.Generator) -> np.ndarray:
    """
